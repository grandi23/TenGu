    ...
    public class LayoutMenu
    {
        public LayoutMenu()
        {
            MenuList = new List<MenuNode>()
            {
                ...
                new MenuNode(){ Icon = "icon-document-edit", DisplayName = "采购订单",Url = "/InfoList/PurchaseOrderIndex", ParentName = "采购信息查询", ParentIcon = "icon icon-align-left"},
                ...
                new MenuNode(){ Icon = "icon icon-minus", DisplayName = "区域仓库",Url = "/Platform/RegionWareHouseConfigIndex", ParentName = "系统配置", ParentIcon = "icon icon-media-shuffle"},
                new MenuNode(){ Icon = "icon icon-plus", DisplayName = "采购任务分配",Url = "/Platform/PurchaseTaskAssignIndex", ParentName = "系统配置", ParentIcon = "icon icon-media-shuffle"},
                new MenuNode(){ Icon = "icon icon-camera", DisplayName = "运营活动",Url = "/Platform/OperateActiveIndex", ParentName = "系统配置", ParentIcon = "icon icon-media-shuffle"},
                new MenuNode(){ Icon = "icon icon-cloud", DisplayName = "工厂专供产品",Url = "/Platform/FactoryForProductIndex", ParentName = "系统配置", ParentIcon = "icon icon-media-shuffle"},
