...
//BACKGROUND CHANGER
  ...
  $(function() {
      $("#button-bg").click(function() {
          $("body").css({
              "background": "url('Content/img/bg5.jpg') repeat"
          });
      });

      $("#button-bg2").click(function() {
          $("body").css({
              "background": "url('Content/img/bg2.jpg') repeat"
          });
      });
      ...
      $("#button-bg8").click(function() {
          $("body").css({
              "background": "url('Content/img/bg8.jpg') repeat"
          });
      });
      $("#button-bg9").click(function() {
          $("body").css({
              "background": "url('Content/img/bg9.jpg') repeat"
          });
      });

      $("#button-bg10").click(function() {
          $("body").css({
              "background": "url('Content/img/bg10.jpg') repeat"
          });
      });

      $("#button-bg11").click(function() {
          $("body").css({
              "background": "url('Content/img/bg11.jpg') repeat"
          });
      });

      $("#button-bg12").click(function() {
          $("body").css({
              "background": "url('Content/img/bg12.jpg') repeat"
          });
      });
